package com.thehappycode.retrievedata;

import com.thehappycode.retrievedata.model.Course;
import com.thehappycode.retrievedata.repository.CourseRepository;
...
@SpringBootTest
class RetrieveDataApplicationTests {
    ...
    private List<Course> getCourseList() {
        Course rapidSpringBootCourse = new Course(
        ...
        Course springSecurityDslCourse = new Course(
        ...
        Course rapidPythonCourse = new Course(
            "Getting Started with Python",
            "Python",
            5,
            "Learn Python concepts in easy steps"
        );
        Course gameDevelopmentWithPython = new Course(
            "Game Development with Python",
            "Python",
            3,
            "Learn Python by developing 10 wonderful games"
        );
        Course javaScriptForAll = new Course(
            "JavaScript for All",
            "JavaScript",
            4,
            "Learn basic JavaScript syntax that can apply to anywhere"
        );
        Course javaScriptCompleteGuide = new Course(
