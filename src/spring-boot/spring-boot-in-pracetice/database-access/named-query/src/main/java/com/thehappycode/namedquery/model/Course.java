package com.thehappycode.namedquery.model;
...
// TODO: Sử dụng một câu query 
@NamedQuery(
    name = "Course.findAllByCategoryAndRating",
    query = "SELECT c FROM  Course c WHERE c.category=?1 and c.rating=?2"
)

// TODO: Sử dụng nhiều câu queries
// @NamedQueries(
//     {
//         @NamedQuery(
//             name = "Course.findAllByCategoryAndRating",
//             query = "SELECT c FROM  Course c WHERE c.category=?1 and c.ratting=?2"
//         )
//     }
// )
